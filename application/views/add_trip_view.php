              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="p-5">
                    ...
                    <form method="post" action="<?php echo base_url('trip_management/add_validation');?>" class="form-horizontal">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    ...
                                    <select  type="text" name="route_id" id="route_id"  class="form-control" required>
                                      ...
                                      <?php foreach($route as $id ):?>

                                      <option value="<?php echo $id->route_id ?>"><?php echo $id->route_name  ?></option>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <select  type="text" name="depart_time"  class="form-control" required>
                                      ...
                                      <optgroup label="AM Trip Shcedule">
                                      ...
                                      <optgroup label="PM Trip Schdule">
                                ...
                                <div class="col-sm-6 col-sm-offset-4">
                                  ...
                                  <input type="submit" name="submit" value="Save Trip" class="btn btn-primary">
                                </div>
                              </form>
                  </div>
                </div>
