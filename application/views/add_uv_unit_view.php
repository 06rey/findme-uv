        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form method="post" action="<?php echo base_url('uv_unit/add_validation');?>" class="form-horizontal">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="number" class="form-control " id="max_pass" name="max_pass" value="" required>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control form-control-user" id="franchise_no" name="franchise_no" required>
                            </div>
                          </div>
