        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form method="post" action="<?php echo base_url('employee/add_clerk_validation/clerk');?>" class="form-horizontal">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" name="username" id="username"  class="form-control" value="<?php echo $employee->contact_no; ?>">
                            </div>
                          </div>
